...
void main()
{
    effect ePer = EffectVisualEffect(VFX_DUR_BLUR);
    effect ePer2 = EffectVisualEffect(VFX_DUR_GLOW_LIGHT_RED);
    effect ePer3 = EffectConcealment(75);
    ...
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, ePer3,OBJECT_SELF);
