...
string SINGLEBOOT = "You are only allowed one character at a time on this "+
            "server. Your registered character is: ";
...
string NOHCRENABLED = "This Server has not yet enabled any HCR features.  "+
        "Please ask the Creator to read the Manual and set up the HCR features.";
