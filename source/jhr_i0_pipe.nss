...
{
    string sEmote1 = "Ahhh! That's better!";
    string sEmote2 = "I like the smell of a pipe.";
    string sEmote3 = "Nothing better than a good smoke!";
    float fHeight = 1.7;
    float fDistance = 0.1;
    ...
    */
    // glow red
    AssignCommand(oActivator, ActionDoCommand(ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectVisualEffect(VFX_DUR_LIGHT_RED_5), oActivator, 30.0)));
