...
const int     X2_CI_CRAFTWAND_COSTMODIFIER   = 100;
...
object CICraftBrewPotion(object oCreator, int nSpellID )
{
    ...
    if (nPropID != -1)
    {
        ...
        oTarget = CreateItemOnObject(X2_CI_BREWPOTION_NEWITEM_RESREF,oCreator,10);
...
int CICraftCheckBrewPotion(object oSpellTarget, object oCaster)
{
    ...
    //float nExperienceCost = 0.0; // xp = 1/25 of gp value
    int nGoldCost = nCost;
