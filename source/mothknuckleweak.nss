...
DelayCommand(1.0,FloatingTextStringOnCreature("<cðøþ>*Grasshopper Knuckles Effect Applied!*</c>",oPC));
...
DelayCommand(1.0,IPSafeAddItemProperty(oMyWeapon,ItemPropertyDamageBonus(nType,IP_CONST_DAMAGEBONUS_1d6),TurnsToSeconds(nDuration), X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE,TRUE));
return;
}
else
{
