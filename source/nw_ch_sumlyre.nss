...
void main()
{
    ...
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectSkillIncrease(SKILL_LISTEN,4),OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectSkillIncrease(SKILL_SPOT,4),OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectVisualEffect(VFX_DUR_PROTECTION_EVIL_MAJOR),OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectDamageIncrease(1,DAMAGE_TYPE_ACID),OBJECT_SELF);
