...
float CFLOAT_SKILLGAIN_ADJUST_GEMCUTTING            = -0.3f;
float CFLOAT_SKILLGAIN_ADJUST_JEWELCRAFTING         = -0.5f;
...
int CINT_FLATFAILURE_GEMCUTTING               = 45;
int CINT_FLATFAILURE_JEWELCRAFTING            = 45;
