...
void CreateOreOnPlayer(int iOreType, object oPlayer)
{
    ...
    //FloatingTextStringOnCreature("You have found some " + sMaterialName + " ore!", OBJECT_SELF, FALSE);
    string sOreTag = "ATS_R_" + CSTR_ORE_BASETAG + "_N_" + ATS_GetMaterialTag(iOreType);
    ////ATS_CreateItemOnPlayer(sOreTag, oPlayer);
    object oCreatedItem = CreateObject(OBJECT_TYPE_ITEM, ATS_GetResRefFromTag(sOreTag), GetLocation(OBJECT_SELF));
...
void CreateRoughGemOnPlayer(int iGemType, object oPlayer)
{
    ...
    //FloatingTextStringOnCreature("You have found a rough " + sMaterialName + "!", OBJECT_SELF, FALSE);
    string sGemTag = "ATS_R_" + CSTR_GEM_BASETAG + "_N_" + ATS_GetMaterialTag(iGemType);
    //ATS_CreateItemOnPlayer(sOreTag, oPlayer);
    object oCreatedItem = CreateObject(OBJECT_TYPE_ITEM, ATS_GetResRefFromTag(sGemTag), GetLocation(OBJECT_SELF));
    //AssignCommand(oPlayer, ActionPickUpItem(oCreatedItem));
}
