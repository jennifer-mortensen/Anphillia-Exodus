...
// setting campaign variables, and givi//ng rewards.
...
string sHasMetSuffix = "_MET";
string sHasHiredSuffix = "_HIRED";
string sDidQuitSuffix = "_QUIT";
string sFriendSuffix = "_FR";
string sHasInterjectionSuffix = "_INTJ";
string sInterjectionSetSuffix = "_INTJ_SET";
string sAdviceSuffix = "_ADV";
string sPersuadeAttemptSuffix = "_PERSUADE";
string sPersuadeSuccessSuffix = "_PERSUADE_SUCC";
string sThreatenSuffix = "_THREAT";

/**** Names for the local variables that go on the NPCs ****/

// Holds the current one-liner
string sOneLinerVarname = "X0_CURRENT_ONE_LINER";

// Holds whether this NPC's one-shot event has occurred
string sOneShotVarname = "X0_ONE_SHOT_EVENT";
...
// attempts.
float CONVERSATION_ATTEMPT_DELAY = 3.0;
