...
// * ----------------------
int SYR_DEFAULT = 10; int SYR_RICH = 50; int SYR_POOR = 2; int SYR_HIGH = 10; int SYR_LOW = 2;
/////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////
//
...
// * The Default setting (= 10) results in a relatively low level compared to the (IMHO)
// * greatly inflated 3rd edition levels.
// * The High setting (= 50) results in around 1/2 of the treasure in the 3rd edition (consistant with
// * the current HCR setting.
// * The Low setting (=2) results in a cash poor world.
// * If you wish to use this number to tailor drops, it acts as a percentage multiplier.
// * Thus - cash level default of 6 results in 6% of the base treasure dropping.
int CashLevel = 10;  //Options: SYR_DEFAULT / SYR_RICH / SYR_POOR //
//
...
// * Customizing this value is more complex since it acts on several functions.  But essentially
// * Lowering the number has the following effects:
// * Numerical effects:  Every two points the MagicLevel is increased or decreased reduces the effective CR
// *  of the creature by one (CR = CR + (MagiclLevel/2) - 3).  Thus the default CR of 6 results in the CR being unchanged.
// *  A CR of 10 results in the effective CR being two higher and a CR of 2 results in the
// *  effective CR being two lower.
// * In addition - if MagicLevel = SYR_LOW the likelihood of multiple items decreases.
// * and if MagicLevel = SYR_HIGH the likelihood of multiple items increases.
int MagicLevel = 1; //OPTIONS:  SYR_DEFAULT / SYR_HIGH / SYR_LOW //
//
