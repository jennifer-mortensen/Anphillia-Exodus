...
void main()
{
    ...
    ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, eAOE, lTarget,HoursToSeconds(2));
    ...
    ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eFieldOfSharp, oVisual,HoursToSeconds(2));
}
