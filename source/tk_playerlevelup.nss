// If your module doesn't have an OnPlayerLevelup script, use this.
...
// leveling character to acquire feats (and levels); it doesn't need to
// be dead last.
// Naturally, "GetPCLevellingUp()" can be replaced by a variable that
