...
void main()
{
    ...
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectVisualEffect(VFX_DUR_GLOW_ORANGE),OBJECT_SELF);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectVisualEffect(VFX_DUR_IOUNSTONE_YELLOW),OBJECT_SELF);
    SetLocalInt(OBJECT_SELF,"Hired",FALSE);
