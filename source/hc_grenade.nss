...
//  Determine damage and effect types
    if(sNM == "hc_holywater")
    {
        ...
        eDam = EffectDamage(d8(3), DAMAGE_TYPE_DIVINE);
        eSplash = EffectDamage(d4(), DAMAGE_TYPE_DIVINE);
    } else if(sNM == "hc_acidflask") {
        eVis = EffectVisualEffect(VFX_IMP_ACID_S);
        eDam = EffectDamage(d8(4), DAMAGE_TYPE_ACID);
        eSplash = EffectDamage(d8(), DAMAGE_TYPE_ACID);
        ...
        eDam = EffectDamage(d8(2), DAMAGE_TYPE_FIRE);
        eSplash = EffectDamage(d4(), DAMAGE_TYPE_FIRE);
    }
