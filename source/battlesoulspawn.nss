...
ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectSpellResistanceIncrease(33), OBJECT_SELF);
ApplyEffectToObject(DURATION_TYPE_PERMANENT, EffectConcealment(52), OBJECT_SELF);
