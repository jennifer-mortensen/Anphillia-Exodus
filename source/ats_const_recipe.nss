...
int ATS_CRAFT_PART_RODS             = 2;
int ATS_CRAFT_PART_STAFFS           = 3;
int ATS_CRAFT_PART_WANDS            = 4;
int ATS_CRAFT_PART_MASTERJEWELRY    = 5;
...
// Free
// int ATS_CRAFT_PART_MISC                  = 9; // Same as Armorcrafting
...
string CSTR_CRAFT_WEAPONCRAFTING_CATEGORY_7     =   "";
...
string CSTR_CRAFT_JEWELCRAFTING_CATEGORY_2          =   "Magic Rods";
string CSTR_CRAFT_JEWELCRAFTING_CATEGORY_3          =   "Magic Staffs";
string CSTR_CRAFT_JEWELCRAFTING_CATEGORY_4          =   "Magic Wands";
string CSTR_CRAFT_JEWELCRAFTING_CATEGORY_5          =   "Master Crafter Items";
