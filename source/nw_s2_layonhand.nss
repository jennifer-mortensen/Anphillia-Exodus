...
void main()
{
    ...
    int nChr = GetAbilityModifier(ABILITY_CHARISMA)+3;
    if (nChr < 0)
    {
        nChr = 0;
    }
    ...
    nHeal = FloatToInt(IntToFloat(nHeal) * 0.50); //J. Persinne; Lay on Hands is 50% as effective now since we've made it 3 uses/day.
