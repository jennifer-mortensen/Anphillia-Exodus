...
float f1st_GetSpeed_PercentChange(object oCreature, float fWalkRate, float fDefault_Rate=0.0)
{
  ...
  switch (nRace)
   {
      case RACIAL_TYPE_DWARF: fRace_Speed = 1.6; break;
      case RACIAL_TYPE_ELF: fRace_Speed = 1.6; break;
      case RACIAL_TYPE_GNOME: fRace_Speed = 1.6; break;
      case RACIAL_TYPE_HALFLING: fRace_Speed = 1.6; break;
