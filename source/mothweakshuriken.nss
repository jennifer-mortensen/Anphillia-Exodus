...
{
   IPSafeAddItemProperty(oTarget, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ELECTRICAL,IP_CONST_DAMAGEBONUS_2), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING,FALSE, TRUE);
   IPSafeAddItemProperty(oTarget, ItemPropertyOnHitProps(IP_CONST_ONHIT_LESSERDISPEL, IP_CONST_ONHIT_SAVEDC_14), fDuration,X2_IP_ADDPROP_POLICY_REPLACE_EXISTING );
        ...
        if (nDuration>0)
           {
                ...
                {
                    TakeGoldFromCreature(250,OBJECT_SELF,TRUE);
