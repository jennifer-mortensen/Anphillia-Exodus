...
int iBaseType;
    ...
    {
    oMyWeapon = GetItemInSlot(INVENTORY_SLOT_HEAD, oTarget);
   }
...
DelayCommand(1.0,FloatingTextStringOnCreature("<cڥ#>*Helmet Enhancement Applied!*</c>",oPC));
...
DelayCommand(1.0,AddItemProperty(DURATION_TYPE_TEMPORARY,ItemPropertyDamageResistance(IP_CONST_DAMAGETYPE_SLASHING,IP_CONST_DAMAGERESIST_5),oMyWeapon,RoundsToSeconds(nDuration)));
}
return;
}
else
