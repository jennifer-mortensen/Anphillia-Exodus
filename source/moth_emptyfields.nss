...
void main()
{
    ...
    effect eLink = EffectLinkEffects(eAC, eEntangle);
    ...
    TLVFXPillar(VFX_FNF_LOS_HOLY_20,lSpell, 1, fDelay1, 6.0f, 2.0f);
    TLVFXPillar(VFX_FNF_LOS_EVIL_20,lSpell, 1, fDelay1+0.4, 6.0f, 2.0f);
    DelayCommand(0.1,TLVFXPillar(VFX_FNF_LOS_EVIL_30,lSpell, 1, 0.0f, 1.2f));
    DelayCommand(0.2,TLVFXPillar(VFX_FNF_LOS_HOLY_30,lSpell, 1, 0.0f, 0.9f));
