...
void ATS_SkinAnimal()
{
    ...
    string sMeatResRef = "it_mmidmisc006";
    ...
    /*for(i = 0; i < iMeatAmount; ++i)
    {
        ...
        {
            SendMessageToPC (oPlayer, "Bad meat ref?");
    ...
    object oCorpseBlood = CreateObject(OBJECT_TYPE_PLACEABLE, "mothbloodstain", lCorpseLoc, FALSE);
