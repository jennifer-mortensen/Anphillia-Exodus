...
void main()
{
    ...
    effect eShield = EffectDamageShield(nDamage, DAMAGE_BONUS_1d12, DAMAGE_TYPE_DIVINE);
    effect eDur = EffectVisualEffect(VFX_DUR_AURA_PULSE_YELLOW_WHITE);
    effect eImmune = EffectDamageImmunityIncrease(DAMAGE_TYPE_NEGATIVE,nDuration/2);
