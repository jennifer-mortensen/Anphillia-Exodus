...
// with hc_   To do so, open them in script editor, and click compile and save.
    ...
    string LOGINMESSAGE="<cþ  >Welcome to Anphillia Exodus. This module is a heavily modified version of the Anphillia Genesis module posted on Neverwinter Vault - a popular, 'more modern' take on the classic two faction Anphillia RP-PvP module. Please be sure to read the 'Important' sections located in your journal.</c>";
